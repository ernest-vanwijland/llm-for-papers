...
\newenvironment{subproof}[1][\proofname]{\renewcommand{\qedsymbol}{$\blacksquare$}\begin{proof}\textcolor{red}{TOPROVE 0}\end{proof}}
...
\newenvironment{proofof}[1]{\begin{proof}\textcolor{red}{TOPROVE 1}\end{proof}}
\newenvironment{proofsketch}{\begin{proof}\textcolor{red}{TOPROVE 2}\end{proof}}

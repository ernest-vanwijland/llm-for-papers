...
\noindent{\bf Case 1.} $|g\cap (e-s)| \geq 2$. Let $b\neq a$ such that $b\in g \cap (e-s)$. 
...
\noindent{\bf Case 2.} $g \cap (e- s) = \{ a \}$.

\medskip

\noindent{\bf Case 2.a.} $v((g\cup e)-a) >\alpha T$.
...
\noindent{\bf Case 2.b.} $v((g\cup e)-a) \leq \alpha T$.
  ...
  \noindent{\bf Case 2.b.i.} $h\cap (e-a)= \emptyset$. 
...
giving a contradiction. We start by exploding $g^p$ with
  ...
  \noindent{\bf Case 2.b.ii.} $h\cap (e-a) \neq \emptyset$.
...
\noindent{\bf Case 2.} Suppose now  that $|(C\setminus W)\cap f|\geq
t_1 + 1$ for 
